...
export default function MyProfile() {
  ...
  const getUserType = () => {
    ...
    if (roles?.includes(ROLE_NAMES.GENERAL_USER)) return 'Patient';
    return 'User';
  };
          ...
          <View style={tw`absolute top-12 left-0 right-0 items-center`}>
            ...
            >
              {user?.profilePicUrl ? (
                ...
                <View style={tw`h-24 w-24 rounded-full bg-white bg-opacity-30 items-center justify-center border-4 border-white dark:border-gray-800`}>
