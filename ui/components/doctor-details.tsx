...
const DoctorDetails: React.FC<DoctorDetailsProps> = ({ doctorId, onPress, showFullDetails = false }) => {
        ...
        <View style={tw`flex-1`}>
          ...
          <View style={tw`flex-row items-center mt-2`}>
            ...
            <MyText style={tw`text-gray-600 dark:text-gray-400 text-sm ml-1`}>
              {doctor.qualifications || 'MBBS, MD'} • 10+ years
            </MyText>
          </View>
        </View>
      </View>
        ...
        <View style={tw`mt-4`}>
          ...
          <View style={tw`mt-3`}>
            <MyText style={tw`text-gray-700 dark:text-gray-300 text-sm`}>
              Dr. {doctor.name} is a highly experienced physician with over 10 years of practice. 
              Specializing in comprehensive healthcare, Dr. {doctor.name.split(' ')[0]} is dedicated 
              to providing personalized treatment plans for each patient.
            </MyText>
          </View>
        </View>
      ) : (
